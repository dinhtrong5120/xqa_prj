...
from xqa_web_tvso.app.logics.syo.db.funtion_database import change_password, add_new_user, delete_user, get_all_user
        ...
        if st.session_state.position != "staff":
            ...
            with row_butt[0]:
                if st.button("CREATE ACCOUNT", use_container_width=True):
                    notice = add_new_user(st.session_state.username_,
                                        #   st.session_state.password_new_,
                                          st.session_state.type_acc,
