...
from xqa_web.app.logics.itest.itest_btn_man import run_btn_inteligent_test, get_link_folder_output , get_data_folder
import os
import io
from xqa_web.app.logics.prokan.read_data_view import zip_folder
from xqa_web.app.logics.itest.itest_compare_youbouhyo_suse_ato import run_compare_youbouhyo_suse_ato
from xqa_web.app.logics.itest.edit_file import save_itest
from xqa_web.app.logics.itest.upload_itest import *

# from xqa_web.app.setting import BASE_DIR_OUTPUTS, BASE_DIR_DATAS
# st.set_page_config(
