...
from xqa_web.app.logics.syo.db.funtion_database import offline_edit
from xqa_web.app.setting import BASE_DIR_FORM_OUT, BASE_DIR_DATAS, BASE_DIR_CADICS_TEMP, VALID_KEY_車両仕様表サンプル
