...
from xqa_web.app.logics.itest.itest_btn_man import get_link_folder_output, data_normalization
from xqa_web.app.logics.itest.create_youbohyo_cpfile import *
