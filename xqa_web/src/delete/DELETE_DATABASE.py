...
from xqa_web.app.logics.syo.db.function_database_new import querry_to_show_project, delete_project_syo
from xqa_web.app.logics.syo.db.funtion_database import querry_to_show_project_prokan, delete_project__
